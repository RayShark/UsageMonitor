...
package protocol Sub2APIRequestLoading {
    func data(for request: URLRequest) async throws -> (Data, URLResponse)
}

extension URLSession: Sub2APIRequestLoading {}

package enum Sub2APIClientError: Error, Equatable {
    ...
    package var isUnauthorized: Bool {
        switch self {
        case .authorizationFailure:
            return true
...
package final class Sub2APIClient {
    private let requestLoader: Sub2APIRequestLoading
    private let decoder = JSONDecoder.sub2api

    package init(requestLoader: Sub2APIRequestLoading = URLSession.shared) {
        self.requestLoader = requestLoader
    }

    package func usage(baseURL: URL, apiKey: String) async throws -> UsageResponse {
