...
package struct UsageResponse: Codable, Equatable {
    package let isValid: Bool
    package let mode: String
    package let modelStats: [UsageModelStat]
    package let planName: String
    package let remaining: Double
    package let subscription: UsageSubscription
    package let unit: String
    package let usage: UsageUsageSummary
...
package struct UsageModelStat: Codable, Equatable {
    ...
    package let inputCostUSD: Double
    package let outputCostUSD: Double
...
package struct UsageSubscription: Codable, Equatable {
    package let dailyUsageUSD: Double
    package let dailyLimitUSD: Double
    package let weeklyUsageUSD: Double
    package let weeklyLimitUSD: Double
    package let monthlyUsageUSD: Double
    package let monthlyLimitUSD: Double
...
package struct UsageUsageSummary: Codable, Equatable {
    package let today: UsageUsageBucket
    package let total: UsageUsageBucket
    package let averageDurationMS: Double
    package let rpm: Double
    package let tpm: Double
...
package struct UsageUsageBucket: Codable, Equatable {
    package let requestCount: Int
    package let inputTokens: Int
    package let outputTokens: Int
    package let totalTokens: Int
...
extension JSONDecoder {
    package static var sub2api: JSONDecoder {
...
extension JSONEncoder {
    package static var sub2api: JSONEncoder {
